...
// ====================================================================
// Split-phase host wrappers (profiling mode)
// ====================================================================
...
void dar_phase_a(
  ...
  AT_DISPATCH_SWITCH(
      input.scalar_type(), "dar_phase_a",
      AT_DISPATCH_CASE(at::ScalarType::BFloat16,
        [&] {
          dar_phase_a_kernel<__nv_bfloat16>
              <<<grid, block, shared_bytes, stream>>>(
              reinterpret_cast<const __nv_bfloat16*>(
                  input.data_ptr()),
              topk_ids.data_ptr<int32_t>(),
...
void dar_phase_d1(
  ...
  AT_DISPATCH_SWITCH(
      dispatch_recv.scalar_type(), "dar_phase_d1",
      AT_DISPATCH_CASE(at::ScalarType::BFloat16,
        [&] {
          dar_phase_d1_kernel<__nv_bfloat16>
              <<<grid, block, 0, stream>>>(
              reinterpret_cast<__nv_bfloat16*>(
                  dispatch_recv.data_ptr()),
              expert_topk_ids.data_ptr<int64_t>(),
